...
export default function SupportSection({ lang }: { lang: Lang }) {
    ...
    return (
        <section
            id="support"
            className="section-pad bg-navy-50 dark:bg-navy-800/50"
        >
            <div className="container-page">
                <div className="relative overflow-hidden rounded-[36px] bg-navy-900 p-8 text-white sm:p-12 dark:ring-1 dark:ring-navy-700">
                    <span className="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-bolt-500/20 blur-3xl" />
                    <div className="relative grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                        <div>
              <span className="inline-flex items-center gap-2 text-sm font-bold text-gold-400">
                <Headphones size={16} /> {en ? "Support" : "Msaada"}
              </span>
                            <h2 className="mt-4 text-4xl font-black">{t.supportTitle}</h2>
                            <p className="mt-4 max-w-xl leading-7 text-navy-200">
                                {t.supportText}
                            </p>
                        </div>
                        <div className="grid gap-3">
                            <a
                                ...
                                className="group flex items-center gap-4 rounded-2xl bg-gold-500 p-4 font-bold text-navy-900 transition hover:bg-gold-400"
                            >
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-navy-900 text-gold-400">
                  ...
                  {en ? "Email support" : "Tuma barua pepe"}
                            ...
                            <a
                                href="tel:0682131140"
                                className="group flex items-center gap-4 rounded-2xl border border-white/20 bg-white/10 p-4 font-bold text-white transition hover:bg-white/10"
                            >
